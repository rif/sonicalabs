...
db.define_table("sounds",
    ...
    Field('file', 'upload', requires=IS_UPLOAD_FILENAME(extension='mp3'), comment=T('MP3 file. 10Mb size limit.'), error_message=T('Inappropiate extension, Please Upload MP3 file only')),
